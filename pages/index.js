  ...
  render() {
    return(
      <Layout>
        ...
        <p>The user can transfer this tokens to others in the "transfer" section.</p>
        ...
        <p><b>Remember!</b> You need MetaMask Chrome extension installed to perform operation on this website.</p>
        <p><b>Remember!</b> Operations with FIDO token can only be done through the main contract.</p>
        <br />
      </Layout>
    )
  }
